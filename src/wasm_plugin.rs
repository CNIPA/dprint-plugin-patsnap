...
struct PatsnapPluginHandler;

impl SyncPluginHandler<Configuration> for PatsnapPluginHandler {
    fn resolve_config(
        &mut self,
        config: ConfigKeyMap,
        ...
        PluginResolveConfigurationResult {
            ...
            file_matching: FileMatchingInfo {
                file_extensions: vec!["patsnap".to_string()],
                file_names: vec![],
            },
        }
    }
    ...
    fn plugin_info(&mut self) -> PluginInfo {
        ...
        PluginInfo {
            ...
            config_key: "patsnap".to_string(),
            help_url: "https://github.com/user/dprint-plugin-patsnap".to_string(),
...
generate_plugin_code!(PatsnapPluginHandler, PatsnapPluginHandler);
